...
BERTests(randomSignal, zerosSignal, onesSignal, 0); % test dla sygnalu bez randomizacji
BERTests(randomSignal, zerosSignal, onesSignal, 1); % test dla sygnalu z randomizacja